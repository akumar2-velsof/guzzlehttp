...
use GuzzleHttp1\Ring\Client\CurlHandler;
use GuzzleHttp1\Ring\Client\CurlMultiHandler;
use GuzzleHttp1\Ring\Client\StreamHandler;
use GuzzleHttp1\Ring\Client\Middleware;
