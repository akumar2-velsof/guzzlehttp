<?php
namespace GuzzleHttp1;

use GuzzleHttp1\Event\HasEmitterTrait;
use GuzzleHttp1\Message\MessageFactory;
use GuzzleHttp1\Message\MessageFactoryInterface;
use GuzzleHttp1\Message\RequestInterface;
use GuzzleHttp1\Message\FutureResponse;
...
class Client implements ClientInterface
{
    ...
    /**
     * @deprecated Use {@see GuzzleHttp1\Pool} instead.
     * @see GuzzleHttp1\Pool
     */
    ...
    /**
     * @deprecated Use GuzzleHttp1\Utils::getDefaultHandler
     */
    ...
    /**
     * @deprecated Use GuzzleHttp1\Utils::getDefaultUserAgent
     */
