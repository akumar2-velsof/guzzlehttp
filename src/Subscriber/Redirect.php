...
use GuzzleHttp1\Exception\BadResponseException;
use GuzzleHttp1\Exception\CouldNotRewindStreamException;
use GuzzleHttp1\Exception\TooManyRedirectsException;
